...
export default function BlogContent() {
  return (
    <div className="w-[920px] h-[1772px] pr-28">
      ...
      <img src={Post} className="w-full h-[400px] rounded-4xl" />
      <Text className="mb-8 mt-4" variant="muted">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac
        ultrices odio. Nulla at congue diam, at dignissim turpis. Ut
        vehicula sed velit a faucibus. In feugiat vestibulum velit vel pulvinar.
      ...
      <Text variant="muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac ultrices odio. Nulla at 
