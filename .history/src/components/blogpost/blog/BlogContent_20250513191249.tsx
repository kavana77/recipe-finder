...
export default function BlogContent() {
  return (
    <div className="w-[920px] h-[1772px] pr-28">
      ...
      <Text>What is the biggest misconception that people have about being a professional chef?</Text>
      <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac ultrices odio. Nulla at congue diam, at dignissim turpis. Ut vehicula sed velit a faucibus. In feugiat vestibulum velit vel pulvinar. Fusce id mollis ex. Praesent feugiat elementum ex ut suscipit.</Text>
    </div>
  );
}
