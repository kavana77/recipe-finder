...
const categoryItems: CategoriesItem[]=[
    ...
    { id: 3, image: Meat, title: "Meat", gradient:"from-white to-red-100", shadow:"shadow-lg shadow-green-800" },
    ...
    return(
        <div className="w-full h-[342px] px-14">
            ...
            <div className="flex justify-between">
               ...
               <div className={`w-[32px] h-[32px] rounded-full bg-transparent shadow-2xl flex items-center justify-center ${item.shadow}`}>
                 <img src={item.image} className="w-18 h-12 " />
               </div>
