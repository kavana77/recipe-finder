...
const MoreRecipe=()=>{
    return(
        <div className="w-full h-[868px] px-14 mt-16  ">
            <div className="flex gap-16 mb-12">
            <Text variant="heading" className="">Try this delicious recipe to make your day</Text>
            <Text variant="muted">Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </Text>
            </div>
                    <div className="grid grid-row-2 gap-6">
                        {recipes.map((recipe)=>(
                            <div key={recipe.id} className="w-[280px] h-[316px] overflow-hidden">
