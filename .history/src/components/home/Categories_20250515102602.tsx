...
const categoryItems: CategoriesItem[]=[
    ...
    { id: 2, image: Vegan, title: "Vegan", gradient:"from-white to-green-100", shadow:"shadow-lg shadow-green-400" },
            ...
            <div className="flex justify-between">
                {categoryItems.map((item)=>(
                    <div key={item.id} className={`w-[180px] h-[200px] rounded-4xl bg-gradient-to-b ${item.gradient} flex flex-col items-center justify-center`}>
                        <div className={` w-[72px] h-[72px] bg-transparent rounded-full flex items-center justify-center ${item.shadow}`}>
