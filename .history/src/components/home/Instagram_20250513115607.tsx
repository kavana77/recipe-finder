    ...
    <div className="w-full h-[964px] bg-gradient-to-b from-[#fafafa] to-[#E7F9FD]">
      ...
      <div className="flex justify-between px-14 my-16">
        <div className=" w-[290px] h-[440px] ">
          ...
          <img src={Profile} className="w-8 h-"/>
          <p className="flex flex-col leading-3 text-[12px] font-semibold">FoodieLand.<span className="text-gray-500">Tokyo, Japan</span></p>
          </div>
          {/* post */}
        ...
        <div className=" w-[290px] h-[440px]">
          {/* post-top */}
          <div className="bg-green-600 w-full h-[41px] flex items-center">
          <img src={Profile}/>
          </div>
          {/* post */}
          <div className=" w-full h-[290px]">
