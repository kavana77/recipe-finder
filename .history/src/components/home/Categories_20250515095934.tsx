...
const categoryItems: CategoriesItem[]=[
    { id: 1, image: BreakFast, title: "Breakfast", gradient:"from-gray-100 to-gray-300", shadow:"" },
    { id: 2, image: Vegan, title: "Vegan", gradient:"", shadow:"" },
        ...
        <div className="w-full h-[342px] px-14">
            ...
            <div className="flex justify-between">
                {categoryItems.map((item)=>(
                    <div key={item.id} className {`w-[180px] h-[200px] rounded-4xl bg-gradient-to-b ${item.} `}>
                        <img src={item.image}/> 
