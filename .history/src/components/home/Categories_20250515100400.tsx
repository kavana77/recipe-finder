...
const categoryItems: CategoriesItem[]=[
    { id: 1, image: BreakFast, title: "Breakfast", gradient:"from-white to-gray-100", shadow:"" },
    { id: 2, image: Vegan, title: "Vegan", gradient:"from-white to-green-100", shadow:"" },
    { id: 3, image: Meat, title: "Meat", gradient:"from-white to-green-100", shadow:"" },
    { id: 4, image: Dessert, title: "Dessert", gradient:"from-white to-green-100", shadow:"" },
    { id: 5, image: Lunch, title: "Lunch", gradient:"from-white to-green-100", shadow:"" },
    { id: 6, image: Chocolate, title: "Chocolate", gradient:"from-white to-green-100", shadow:""}
]
const Categories=()=>{
    return(
