...
const Categories = () => {
  return (
    <div className="w-full px-6 md:px-14 py-8">
      ...
      <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:flex gap-4">
        {categoryItems.map((item) => (
          <div
            key={item.id}
            className={`w-full h-[180px] sm:h-[200px] md:w-[180px] rounded-4xl bg-gradient-to-b ${item.gradient} flex flex-col items-center justify-center`}
          >
            <div
