...
const FeaturedRecipe=()=>{
    return(
        ...
        <div className="bg-amber-400 w-[50%] h-full rounded-tl-4xl rounded-bl-4xl">
            ...
            <Text variant="muted" className="px-12 text">Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </Text>
        </div>
        {/* Right Section */}
