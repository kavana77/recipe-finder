...
const categoryItems: CategoriesItem[]=[
    ...
    { id: 3, image: Meat, title: "Meat", gradient:"from-white to-red-100", shadow:"shadow-green-400" },
    ...
    return(
        <div className="w-full h-[342px] px-14">
            ...
            <div className="flex justify-between">
               ...
               <div className={`w-[52px] h-[72px] rounded-full bg-transparent shadow-2xl flex items-center justify-center ${item.shadow}`}>
