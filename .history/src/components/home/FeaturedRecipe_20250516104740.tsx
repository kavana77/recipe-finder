...
const FeaturedRecipe = () => {
  return (
    <div className="flex flex-col md:flex-row w-full h-auto px-14 py-10 relative">
      {/*  Left Section */}
      <div className="bg-[#E7FAFE] w-full md:w-[50%] rounded-tl-4xl rounded-bl-4xl">
        <Button
          variant="secondary"
          className="flex items-center gap-2 mt-3 ml-6 shadow-xl"
        >
          <img src={List} />
          Hot Recipes
        </Button>
        <Text variant="heading" className="text-6xl text-center mr-22 p-6 ">
          Spicy delicious chicken wings
        </Text>
        <Text variant="muted" className="pr-26 pl-16">
      ...
      <img
        src={Image}
        className="w-full md:w-[50%] h-auto object-cover rounded-tr-4xl rounded-br-4xl"
      />
      <img src={Badge} className="absolute top-18 right-150 hidden md:flex" />
    </div>
  );
};
