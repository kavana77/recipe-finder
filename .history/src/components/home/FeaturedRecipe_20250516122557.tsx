...
const FeaturedRecipe = () => {
  return (
    <div className="flex flex-col md:flex-row w-full h-auto px-4 md:px-14 py-10 relative gap-6">
      {/* Left Section */}
      <div className="bg-[#E7FAFE] w-full md:w-1/2 rounded-3xl p-6 flex flex-col justify-between">
        <Button
          variant="secondary"
      ...
      {/* Right Section */}
      <div className="w-full md:w-1/2 relative hidden md:">
        <img
          src={Image}
          alt="Dish"
