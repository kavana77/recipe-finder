...
export default function Footer() {
  return (
    <footer className="w-full px-4 sm:px-8 md:px-14 mt-10 bg-white">
      ...
      {/* Bottom Footer */}
      <div className="relativeflex flex-col sm:flex-row justify-between items-center py-4 text-xs sm:text-sm text-gray-500 gap-4 lg:justify-center">
        <p className="text-center sm:text-left lg:text-c  ">
          © 2020 Flowbase. Powered by <span className="text-red-500">Webflow</span>
        </p>
        <div className="flex gap-3 sm:gap-4 lg:absolute lg:right-0">
