...
const Contact = () => {
  return (
    <div className="w-full min-h-screen px-4 sm:px-8 lg:px-14 mt-16">
      ...
      <div className="hidden flex flex-col lg:flex-row gap-10 max-w-screen-lg mx-auto">
        {/* Image Section */}
        <div className="w-full lg:w-[300px] h-[450px] bg-gradient-to-b from-white to-[#dbf3f8] flex items-end justify-end">
