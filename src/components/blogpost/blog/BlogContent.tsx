  ...
  return (
    <div className="w-full max-w-[920px] ">
      ...
      <div className="bg-gradient-to-r from-gray-300 p-4 border-t border-b border-gray-400 mt-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium text-center">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac ultrices odio.”</h1>
      </div>
